...
SQLCommand = ("SELECT distinct TwID,userID FROM Twitter_Scrape where GEO<>'none'") 
...
while results:
  ...
  user_timeline = twitter.get_user_timeline(user_id=userID,count=200,include_retweets=True,since_id=tweetID)
